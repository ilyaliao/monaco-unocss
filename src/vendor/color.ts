/*
 * Ported from UnoCSS language-server color utilities:
 * https://github.com/unocss/unocss/blob/672200fabdbfb4a8c7d1f30f15acf70c35573a90/packages-integrations/language-server/src/utils/color.ts
 * License: MIT
 * Adapted: Color type imported from vscode-languageserver-protocol.
 */
