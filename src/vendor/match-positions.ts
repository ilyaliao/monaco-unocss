/*
 * Ported from UnoCSS IDE match positions:
 * https://github.com/unocss/unocss/blob/672200fabdbfb4a8c7d1f30f15acf70c35573a90/virtual-shared/integration/src/match-positions.ts
 * License: MIT
 * Adapted: extractor regexes imported from the local vendored module.
 */
